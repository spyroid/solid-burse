...
import com.burse.client.ui.catalog.TopCatalogView;
...
public class ApplicationViewImpl extends Composite implements ApplicationView {
	...
	@UiField
	InlineLabel messages;
	@UiField(provided = true)
	InlineLabel username = new InlineLabel("user@server.local");
	@UiField
	Anchor settingsLink;
	...
	void doCatalogClick(ClickEvent e) {
		changeContent(new TopCatalogView());
	}
